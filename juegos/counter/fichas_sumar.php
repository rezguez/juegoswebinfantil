...
<div class='container-fluid'>
	...
	<div id='printable' class='mainbox  mx-auto'>
		<!-- EMPIEZA mainbox -->
		
		<!-- 		CAJA TITULO -->
		<div class='row p-2 vin justify-content-center mt-0 mb-4'>
			<span
				class='col titulobarra text-center' onclick='openFullscreen()'
				
				style='cursor: pointer; margin-bottom: 0px;'>RECORTA, PEGA, DIBUJA LA SUMA Y CUENTA</span>
		</div>
...
<div id='canvas2' class='row p-0 align-items-center mx-4 mt-6'>
	...
	<div class='col-4 m-0  p-0'>
		...
		<!-- CAJA CANVAS -->
		<div id='canvas' style='height: 9vw; border-top-style: dashed' class='row mx-4 mt-5'></div>
...
function pintamoviles(value, index) {
		...
		document.getElementById("canvas").innerHTML += "<div class='movilidad fichaserie text-center px-0 celdainvisible c7'  id='myelemento-" + tipo + "-" + value + "' style='left:" + calculaposini(index) + "%;'><div class='celda c7' style='position: relative; left:0; top:0;'><img  src='" + urlimg + "' class='numerado ' width=85%>"+txto+"</div></div>";
	}

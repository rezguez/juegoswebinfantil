...
for ($i = 0; $i < ($matriztotal-$numerototal); $i++) {
    do {
       $matriz[$i] = chr(floor(rand(48 , 57.9)));
...
<div class='container-fluid'>
	...
	<div class='mainbox  mx-auto'>
		...
		<div class='row p-2 vin justify-content-center mt-0'><span
				class='col titulobarra text-center'>COLOREA Y CUENTA LOS NÚMEROS IGUALES AL MODELO</span>
		</div>
		...
		<div id='canvas'
			...
			<div class='col-2 ml-3' style='max-width: 300px;'>
				<div
					class='row m-0 mt-2 p-0 justify-content-center align-items-center'>
					<span 	class='letrascrabble-xl esnumero circular-lg sombra'
						style='cursor: pointer;'><?php echo $palabra; ?></span>
				</div>
				<div
					class='row m-0 mt-2 p-0 justify-content-center align-items-center'>

					<span id='faltan' class='celda esnumero letrascrabble-xl'><span style='color:transparent'>9</span></span>
...
for ($i = 0; $i < $lado1; $i ++) {
    ...
    for ($j = 0; $j < $lado2; $j ++) {
        echo "<div class='col  col-lg-1 m-1 p-0'><span class='circular-md esnumero letrascrabble-lg bg-light' onmouseover=\"habla('" . $matriz[($i * $lado2 + $j)] . "')\" onclick='comprueba(this)'>" . $matriz[($i * $lado2 + $j)] . "</span>
</div>";
    }
...
?>
		...
		<div class='row p-2 vin justify-content-center mt-5'><span
				class='col titulobarra text-center' style='border-top-style:dashed;'>REPASA LOS NÚMEROS</span>
		</div>
...
<?php
    ...
    for ($j = 0; $j < $numerototal; $j ++) {
        echo "<div class='col  col-lg-1 m-1 p-0'><span class='fichascrabble esnumero letrascrabble-xl bg-light' style='opacity:0.4'>" . $palabra . "</span>
</div>";
    }

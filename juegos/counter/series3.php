...
$numero1 = 2; // numero objetos de tipo 1
$numero2 = 2; // numero de objetos de tipo 2
$numero3 = 2; // numero de objetos de tipo 3
...
do {
    $dibujo3 = floor(rand(0, count($elem_url) - 0.5)); // objeto tipo 3 (no pueden ser iguales)
} while ($dibujo1 == $dibujo3 or $dibujo2 == $dibujo3);
...
for ($i = 0; $i < 2; $i ++) {
    ...
    <span  class='c7 celda fichaserie sombra text-center tipo3 px-0' width=100%> </span>
    ";
}
?>
		</div>
...
for (z=0;z<(numerototal+3); z++) { lista[z]=z;}
...
function pintamoviles(value, index) {
		...
		tipo="tipo2";
		txto='';
		if (value>=(numero1+numero2+2)) {urlimg= urlimg3; tipo="tipo3";}
